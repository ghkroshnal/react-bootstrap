...
import service1 from '../../Assests/images/services/service-1.png';
import service2 from '../../Assests/images/services/service-2.png';
import service3 from '../../Assests/images/services/service-3.png';
    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end">
          <div className="services__pic">
            <img src= {service2} alt="marketing illustration" className="img-fluid" />
          </div>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-start">
          <div className="services__pic">
            <img src= {service1} alt="web development illustration" className="img-fluid" />
          </div>
        </div>
        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4">
          <div className="services__content">
      ...
      <div className="row">
        ...
        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end">
          <div className="services__pic">
            <img src= {service3} alt="cloud hosting illustration" className="img-fluid" />
          </div>
        </div>
      </div>
    </div>
