...
import Illustration from '../../Assests/images/arts/intro-section-illustration.png';
        ...
        <div className="row align-items-center text-white">
          ...
          <div className="col-md-6 intros text-start">
            <h1 className="display-2">
              <span className="display-2--intro">We'r team Smart Code</span>
          ...
          <div className="col-md-6 intros text-end">
            <div className="video-box">
              <img src= {Illustration} alt="video illutration" className="img-fluid" />
