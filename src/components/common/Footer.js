...
const Footer = () => {
  return (
    <footer className="footer">
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
                ...
                <div className="contact-box__info">
                  <a href="#" className="contact-box__info--title">New York, USA</a>
          ...
          <div className="footer-sm" style={{background: '#212121'}}>
            <div className="container">
          ...
          <div className="container mt-5">
            <div className="row text-white justify-content-center mt-3 pb-3">
              <div className="col-12 col-sm-6 col-lg-6 mx-auto">
                <h5 className="text-capitalize fw-bold">Smart Code</h5>
          ...
          <div className="row text-center text-white">
            <div className="col-12">
              <div className="footer-bottom__copyright">
                  &copy; Copyright 2024-25 <a href="#">Smart Code</a> | Created by{' '}
